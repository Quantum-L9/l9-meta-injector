...
const expected={
  ...
  advanced:["acquireLocalSource","applyCommentInjection","applySchema","ARCHIVE_MEMBER_SEPARATOR","assertCarrierDecisionCoverage","assistField","buildCarrierOperationPlan","buildCorpusIndex","buildDedupEntries","buildDedupReport","buildDuplicateProjection","buildLocalSourceManifest","buildMeta","buildOmitMatcher","buildPrimitiveLibraryIndex","buildPromptLibraryIndex","BUILTIN_NOISE_PATTERNS","BUILTIN_SKILL_PROTECT_PATTERNS","canonicalBlockReason","canonicalCorpusJson","canonicalMemberPath","canonicalPair","CARRIER_PRECEDENCE","CLASS_PLACEMENT_HINTS","classify","classifyArtifact","classifyWithSemantics","compareCodePoints","compileMetadataIndex","compilePlacementPlan","compilePlacementPlans","contentHash","CORPUS_INDEX_SCHEMA","CORPUS_PROFILE_ID","CORPUS_PROFILE_VERSION","corpusAnalysisIdentity","corpusSemanticHash","corpusStableId","dedupReportToMarkdown","DEFAULT_ASSIST_CONFIG","DEFAULT_LOCAL_ARCHIVE_POLICY","DEFAULT_NEAR_DUPLICATE_THRESHOLD","diffsToLogYaml","documentStructureExtractor","ENCODING_CHUNK_BYTES","estimateTokens","executeFileTransaction","extract","extractInjectedYaml","FILE_TRANSACTION_SCHEMA","findFiles","FRONTMATTER_EXTS","FRONTMATTER_PATCH_SCHEMA","frontMatterInner","GENERATED_ARTIFACT_OMIT_PATTERNS","GRAMMAR_ORIGIN_FIELDS","hashFileStreaming","hasInjectedBlock","hasLegacyExtractionOwnership","hasUseWhenSignal","indexedNearDuplicates","injectFile","injectFileAsync","INLINE_MANAGED_ARTIFACT_TYPES","inlinePlanDrift","inspectFrontMatterDocument","isDecodableText","isGoodValue","isLegacyGeneratedExtraction","isProbablyBinary","isSemanticArtifactClass","isSkillArtifactPath","isSkillMdBasename","jaccard","L9_METAIGNORE_FILENAME","LEGACY_EXTRACTION_OWNER_FILE","LEGACY_EXTRACTION_SUFFIX","LOCAL_ARCHIVE_POLICY_VERSION","LOCAL_SOURCE_MANIFEST_SCHEMA","memberCollisionKey","METADATA_INDEX_RELATIVE_PATH","METADATA_INDEX_SCHEMA","metadataIndexDrift","NEAR_DUPLICATE_MAX_BYTES","NEAR_DUPLICATE_METHOD","NEAR_DUPLICATE_MIN_TOKENS","NEAR_DUPLICATE_SHINGLE_SIZE","NEAR_DUPLICATE_VERSION","normalizeFilename","normalizeFilenames","normalizeFilenameWithLog","normalizeForSimilarity","observeLocalSourceModel","parseCanonicalYaml","parseMetadataIndex","patchManagedFrontMatter","physicalManifestDigest","placementHintFor","planCarrierOperationAsync","preflightArchive","probeBufferEncoding","probeFileEncoding","PROSE_ORIGIN_FIELDS","QUARANTINE_DIRECTORY","readUtf8Strict","reconcileFields","reconcileFieldsAsync","recoverPendingTransactions","referenceNearDuplicates","renderCorpusReport","resolveCarrierDecision","resolveCarrierDecisions","resolveLocalArchivePolicy","resolveNamespace","resolveStrategy","scanFiles","SCRATCH_OWNER_FILE","SCRATCH_OWNER_ID","SEMANTIC_ARTIFACT_CLASSES","serializeMetadataIndex","serializeToYamlFrontMatter","shingleSet","sidecarPathFor","splitContent","stripExistingFrontMatter","stripInjectedBlock","targetIncludes","tokenize","toMetaSchema","toRepositoryModelLocalSource","toSnakeCase","toSnakeStem","TRANSACTION_DIRECTORY","verify","withLocalSourceModel","WORK_INTELLIGENCE_PREDICATES","WORK_KIND_VOCABULARY","WORK_STATUS_VOCABULARY","workIntelligenceExtractor","writeLocalSourceManifest","writeMetadataIndex","yamlScalar","yamlToBlock"],
