 ...
 */
export declare const DISCOVERY_DISPOSITIONS: readonly ["eligible", "traversed_directory", "omitted", "hidden_control", "generated_artifact", "extension_filtered", "glob_filtered", "known_binary", "binary_detected", "unsupported_encoding", "unreadable", "symlink", "unsupported_entry"];
