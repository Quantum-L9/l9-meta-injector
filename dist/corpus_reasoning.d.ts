...
export declare const REASONING_GROUNDING_REFS: {
    readonly readiness_evidence_ref: "readiness-evidence.json";
    readonly corpus_coverage_ref: "corpus-coverage.json";
    readonly corpus_snapshot_ref: "corpus-snapshot.json";
};
