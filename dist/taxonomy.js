...
exports.semanticClassToArtifactType = semanticClassToArtifactType;
exports.inventoryTypeToArtifactType = inventoryTypeToArtifactType;
// v3 semantic class → canonical coarse ArtifactType.
const SEMANTIC_CLASS_TO_ARTIFACT_TYPE = {
...
const INVENTORY_TYPE_TO_ARTIFACT_TYPE = {
    spec: "context",
    code: "source",
    schema: "source",
    prompt: "prompt",
