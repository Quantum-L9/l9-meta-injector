...
const AUTHORITY_CRITICAL_PATHS = [
  ...
  "src/corpus_documents.ts",
  "src/corpus_semantics.ts",
  "src/corpus_pairs.ts",
  "src/corpus_fusion.ts",
  "src/corpus_reasoning.ts",
  "src/corpus_embeddings.ts",
  "src/corpus_semantic_run.ts",
  "src/ordering.ts",
  ...
  "dist/corpus_documents.js",
  "dist/corpus_documents.d.ts",
  "dist/corpus_documents.js.map",
  "dist/corpus_semantics.js",
  "dist/corpus_semantics.d.ts",
  "dist/corpus_semantics.js.map",
  "dist/corpus_pairs.js",
  "dist/corpus_pairs.d.ts",
  "dist/corpus_pairs.js.map",
  "dist/corpus_fusion.js",
  "dist/corpus_fusion.d.ts",
  "dist/corpus_fusion.js.map",
  "dist/corpus_reasoning.js",
  "dist/corpus_reasoning.d.ts",
  "dist/corpus_reasoning.js.map",
  "dist/corpus_embeddings.js",
  "dist/corpus_embeddings.d.ts",
  "dist/corpus_embeddings.js.map",
  "dist/corpus_semantic_run.js",
  "dist/corpus_semantic_run.d.ts",
  "dist/corpus_semantic_run.js.map",
  ...
  "docs/decisions/040-semantic-candidate-discovery-and-reasoning-handoff.md",
...
function validateAuthorityDocument(authority) {
  ...
  exactKeys(authority.contracts, ["metadata","pipeline","architecture","public_api","package"], ["operations","repository_authority","authority_scan","check","operation_dispatch","discovery","carrier_policy","metadata_index","carrier_operation","file_transaction","frontmatter_patch","output_placement","local_source","local_archive_policy","archive_preflight","encoding","corpus_analysis","corpus_report","corpus_scan","corpus_roots","corpus_cache","corpus_snapshot","corpus_diff","corpus_session","corpus_readiness","corpus_candidates","corpus_coverage","corpus_qualification","corpus_documents","corpus_semantics","corpus_pairs","corpus_fusion","corpus_reasoning","corpus_embeddings","corpus_semantic_run","corpus_archaeology","semantic_candidates","work_intelligence","ordering","inventory","inventory_archive_member"], "authority.contracts", errors);
