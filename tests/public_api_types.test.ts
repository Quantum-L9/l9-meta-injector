...
describe("public declaration API",()=>{
 test("consumer fixture typechecks with Node16 package exports",()=>{
  ...
  try{
   const cfg={compilerOptions:{target:"ES2020",module:"Node16",moduleResolution:"Node16",strict:true,noEmit:true,skipLibCheck:false,baseUrl:process.cwd(),typeRoots:[path.join(process.cwd(),"node_modules/@types")],paths:{"l9-meta-injector":["src/index.ts"],"l9-meta-injector/inventory":["src/public/inventory.ts"],"l9-meta-injector/schema":["src/public/schema.ts"],"l9-meta-injector/advanced":["src/public/advanced.ts"],"l9-meta-injector/advanced/llm":["src/public/llm.ts"],"l9-meta-injector/repository-model":["src/public/repository_model.ts"]}},files:[path.join(process.cwd(),"fixtures/package-consumer/types.ts")]};
